// =============================================================================
// Companion wire protocol — LF-delimited JSON frames over a duplex stdio pipe.
...
//
// This module is part of the standalone companion bundle, so it must stay
...
// ---- Methods ---------------------------------------------------------------
//
// Dotted method names map 1:1 to Companion capability methods. The daemon's
// rpcServer holds the dispatch table; RemoteCompanion issues these from the
