...
export const GIT_REPO_STATUS_UPDATE = 'git:repo-status-update' // main -> renderer (per-repo, container workspaces)
export const GIT_MONITOR_START = 'git:monitor-start'
export const GIT_MONITOR_SET_REPOS = 'git:monitor-set-repos' // renderer -> main (attention set of repos to poll)
